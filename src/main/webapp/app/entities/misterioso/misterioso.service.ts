...
export class MisteriosoService {
    ...
    /**
     * Convert a returned JSON object to Misterioso.
     */
    private convertItemFromServer(json: any): Misterioso {
        const entity: Misterioso = Object.assign(new Misterioso(), json);
        return entity;
    }

    /**
     * Convert a Misterioso to a JSON which can be sent to the server.
     */
